...
const CalendarIcon = createLucideIcon('calendar', Calendah.IconNode);
...
const PartyPopperIcon = createLucideIcon('party-popper', PartyPoppeh.IconNode);
...
const FolderIcon = createLucideIcon('folder.ts', Foldeh.IconNode);
